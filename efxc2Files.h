...
namespace efxc2Files{
    ...
    public:
        ...
        void set_DisassemblyFile(const efxc2Utils::M_STRING_VIEW _DisassemblyFile) { DisassemblyFile = _DisassemblyFile; DisassemblyFile.make_preferred(); }
        std::filesystem::path get_inputFile() const { return inputFile; }
        void set_inputFile(const efxc2Utils::M_STRING_VIEW _inputFile) { inputFile = _inputFile; inputFile.make_preferred(); }
        std::filesystem::path get_privateDataFile() const { return privateDataFile; }
        void set_privateDataFile(const efxc2Utils::M_STRING_VIEW _privateDataFile) { privateDataFile = _privateDataFile; privateDataFile.make_preferred(); }
        std::filesystem::path get_IncludeFile() const { return IncludeFile; }
        void set_IncludeFile(const efxc2Utils::M_STRING_VIEW _IncludeFile) { IncludeFile = _IncludeFile; IncludeFile.make_preferred(); }
        std::filesystem::path get_ObjectFile() const { return ObjectFile; }
        void set_ObjectFile(const efxc2Utils::M_STRING_VIEW _ObjectFile) { ObjectFile = _ObjectFile;  ObjectFile.make_preferred(); }
        std::filesystem::path get_LibraryFile() const { return LibraryFile; }
        void set_LibraryFile(const efxc2Utils::M_STRING_VIEW _LibraryFile) { LibraryFile = _LibraryFile;  LibraryFile.make_preferred(); }
        std::filesystem::path get_pdbFile() const { return pdbFile; };
        void set_pdbFile(const efxc2Utils::M_STRING_VIEW _pdbFile) { pdbFile = _pdbFile; pdbFile.make_preferred(); }
