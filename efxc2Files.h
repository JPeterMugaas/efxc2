...
public:
    ...
    void set_DisassemblyFile(std::wstring _DisassemblyFile) { DisassemblyFile = _DisassemblyFile;  }
    std::wstring get_inputFile() const { return inputFile; }
    void set_inputFile(std::wstring _inputFile) { inputFile = _inputFile; }
    std::wstring get_IncludeFile() const { return IncludeFile; }
    void set_IncludeFile(std::wstring _IncludeFile) { IncludeFile = _IncludeFile; }
    std::wstring get_ObjectFile() const { return ObjectFile; }
    void set_ObjectFile(std::wstring _ObjectFile) { ObjectFile = _ObjectFile; }
    std::wstring get_pdbFile() const { return pdbFile; };
    void set_pdbFile(std::wstring _pdbFile) { pdbFile = _pdbFile; }
    std::string get_c_pdbFile() const { return c_pdbFile; };
    void set_c_pdbFile(std::string _c_pdbFile) { c_pdbFile = _c_pdbFile; }
#else  /* _WIN32 */
    std::string get_DisassemblyFile() const { return DisassemblyFile; }
    void set_DisassemblyFile(std::string _DisassemblyFile) { DisassemblyFile = _DisassemblyFile; }
    ...
    void set_IncludeFile(std::string _IncludeFile) { IncludeFile = _IncludeFile;  }
    std::string get_ObjectFile() const { return ObjectFile;  }
    void set_ObjectFile(std::string _ObjectFile) { ObjectFile = _ObjectFile;  }
    std::string get_pdbFile() const { return pdbFile;  };
    void set_pdbFile(std::string _pdbFile) { pdbFile = _pdbFile; }
#endif /* _WIN32 */
